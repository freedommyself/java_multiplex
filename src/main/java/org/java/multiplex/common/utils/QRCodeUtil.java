...
public class QRCodeUtil {
     ...
     * @throws Exception MultiFormatWriter().encode(content, BarcodeFormat.QR_CODE, QR_CODE_SIZE, QR_CODE_SIZE,hints);
     */
     ...
     * @param imgPath      嵌入二维码的图片路径
     * @param needCompress 图片是否压缩
     * @throws Exception ImageIO.read(new File(imgPath))
     */
     ...
     * @param file 二维码文件
     * @return 解码后的内容
     * @throws Exception ImageIO.read(file)&MultiFormatReader().decode(bitmap, hints);
     */
